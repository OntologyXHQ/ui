...
if (pkg.name !== '@ontologyx/ui') failures.push(`package name must be @ontologyx/ui, got ${JSON.stringify(pkg.name)}`);
if (pkg.license !== 'MIT') failures.push(`package license must be MIT, got ${JSON.stringify(pkg.license)}`);
...
console.log('Public publish readiness passed: @ontologyx/ui · MIT · OntologyXHQ/ui · public npm · OIDC client floor.');
