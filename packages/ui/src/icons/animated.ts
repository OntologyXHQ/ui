  ...
  transitions: [
    {
      ...
      transient: ['M8.5 6v12l3.2-2V8zm5 0H16v12h-2.5z'],
      motion: 'pulse',
    },
    {
      from: 'pause',
  ...
  transitions: [
    {
      from: 'muted',
      to: 'high',
      transientState: 'unmuting',
      transient: ['M4 10h4l5-4v12l-5-4H4z', 'M16 10a3 3 0 0 1 0 4'],
      motion: 'pulse',
    },
    {
      from: 'high',
      to: 'muted',
      transientState: 'muting',
      transient: ['M4 10h4l5-4v12l-5-4H4z', 'M17 10l3 4'],
      motion: 'pulse',
    },
    {
      from: 'low',
      to: 'high',
      transientState: 'raising',
      transient: ['M4 10h4l5-4v12l-5-4H4z', 'M16 8.5a4.5 4.5 0 0 1 0 7'],
      motion: 'pulse',
    },
    {
      from: 'high',
      to: 'low',
      transientState: 'lowering',
      transient: ['M4 10h4l5-4v12l-5-4H4z', 'M16 9a4 4 0 0 1 0 6'],
      motion: 'pulse',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'off',
      to: 'on',
      transientState: 'favoriting',
      transient: [
        'M12 20S4 15 4 9a4 4 0 0 1 7-2 4 4 0 0 1 7 2c0 6-6 11-6 11Z',
        'M12 5v2M5 12H3M21 12h-2',
      ],
      motion: 'pulse',
    },
    {
      from: 'on',
      to: 'off',
      transientState: 'unfavoriting',
      transient: ['M12 20S4 15 4 9a4 4 0 0 1 7-2 4 4 0 0 1 7 2c0 6-6 11-6 11Z'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      ...
      transient: ['M7 4h10v16l-5-3-5 3z', 'M12 7v7M9 10h6'],
      motion: 'pulse',
    },
    {
      from: 'on',
      to: 'off',
      transientState: 'removing',
      transient: ['M7 4h10v16l-5-3-5 3z', 'M9 10h6'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'off',
      to: 'on',
      transientState: 'enabling',
      transient: ['M6 17h12l-2-3v-3a4 4 0 0 0-8 0v3z', 'M12 5V3'],
      motion: 'pulse',
    },
    {
      from: 'on',
      to: 'off',
      transientState: 'silencing',
      transient: ['M6 17h12l-2-3v-3a4 4 0 0 0-8 0v3z', 'M6 6l12 12'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'hidden',
      to: 'visible',
      transientState: 'revealing',
      transient: ['M3 12s3.5-5 9-5 9 5 9 5-3.5 5-9 5-9-5-9-5Z'],
      motion: 'pulse',
    },
    {
      from: 'visible',
      to: 'hidden',
      transientState: 'hiding',
      transient: ['M3 12s3.5-5 9-5 9 5 9 5-3.5 5-9 5-9-5-9-5Z', 'M7 7l10 10'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      ...
      transient: ['M6 10h12v10H6z', 'M15 10V7a3 3 0 0 0-5-2'],
      motion: 'pulse',
    },
    {
      from: 'unlocked',
      ...
      transient: ['M6 10h12v10H6z', 'M9 10V7a3 3 0 0 1 6 0'],
      motion: 'pulse',
    },
  ],
});
...
export const ConnectivityStateGlyph = /* @__PURE__ */ defineUiIcon({
  ...
  states: {
    offline: [
      'M4 4l16 16',
      'M5 9a12 12 0 0 1 12.5-2',
      'M7 13a8 8 0 0 1 7.5-1',
      'M10 17a4 4 0 0 1 4 0',
    ],
  ...
  transitions: [
    {
      ...
      transient: ['M6 12a9 9 0 0 1 12 0', 'M9 15a5 5 0 0 1 6 0', 'M12 19h.01'],
      motion: 'pulse',
    },
    {
      from: 'online',
      to: 'offline',
      transientState: 'disconnecting',
      transient: ['M6 12a9 9 0 0 1 12 0', 'M6 6l12 12'],
      motion: 'replace',
    },
  ],
});
...
export const SyncStateGlyph = /* @__PURE__ */ defineUiIcon({
  ...
  states: {
    idle: [
      'M19 7v5h-5',
      'M5 17v-5h5',
      'M18 12a6 6 0 0 0-10.5-4L5 12',
      'M6 12a6 6 0 0 0 10.5 4L19 12',
    ],
  ...
  transitions: [
    {
      from: 'idle',
      to: 'synced',
      transientState: 'syncing',
      transient: ['M19 7v5h-5', 'M5 17v-5h5', 'M18 12a6 6 0 0 0-10.5-4L5 12'],
      motion: 'rotate',
    },
    {
      from: 'synced',
      to: 'idle',
      transientState: 'refreshing',
      transient: ['M19 7v5h-5', 'M5 17v-5h5'],
      motion: 'rotate',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'idle',
      to: 'complete',
      transientState: 'downloading',
      transient: ['M12 4v13', 'm-4-4 4 4 4-4', 'M5 20h14'],
      motion: 'pulse',
    },
    {
      from: 'complete',
      to: 'idle',
      transientState: 'resetting',
      transient: ['M12 6v9', 'M5 20h14'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      ...
      transient: ['M12 20V7', 'm-4 4 4-4 4 4', 'M5 4h14'],
      motion: 'pulse',
    },
    {
      from: 'complete',
  ...
  transitions: [
    {
      from: 'collapsed',
      to: 'expanded',
      transientState: 'expanding',
      transient: ['m7 7 5 10 5-10'],
      motion: 'rotate',
    },
    {
      from: 'expanded',
      to: 'collapsed',
      transientState: 'collapsing',
      transient: ['m7 17 5-10 5 10'],
      motion: 'rotate',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'normal',
      to: 'compact',
      transientState: 'shrinking',
      transient: ['M7 7h10v10H7z'],
      motion: 'pulse',
    },
    {
      from: 'compact',
      to: 'normal',
      transientState: 'growing',
      transient: ['M6 6h12v12H6z'],
      motion: 'pulse',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'closed',
      to: 'open',
      transientState: 'opening',
      transient: ['M6 8h12M8 16l8-8'],
      motion: 'rotate',
    },
    {
      from: 'open',
      to: 'closed',
      transientState: 'closing',
      transient: ['M6 8h12M8 16h8'],
      motion: 'rotate',
    },
  ],
});
  ...
  transitions: [
    {
      ...
      to: 'live',
      transientState: 'unmuting',
      transient: ['M9 5a3 3 0 0 1 6 0v7a3 3 0 0 1-6 0z', 'M12 18v3'],
      motion: 'pulse',
    },
    {
      from: 'live',
      to: 'muted',
      transientState: 'muting',
      transient: ['M9 5a3 3 0 0 1 6 0v7a3 3 0 0 1-6 0z', 'M7 7l10 10'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'light',
      to: 'dark',
      transientState: 'dimming',
      transient: ['M12 4a8 8 0 0 0 0 16c3-2 4-5 4-8s-1-6-4-8Z'],
      motion: 'rotate',
    },
    {
      from: 'dark',
      to: 'light',
      transientState: 'brightening',
      transient: ['M12 5a7 7 0 1 0 0 14 7 7 0 0 0 0-14Z'],
      motion: 'rotate',
    },
  ],
});
  ...
  transitions: [
    {
      ...
      transient: ['M12 3v9', 'M8 7a7 7 0 0 0 8 0'],
      motion: 'pulse',
    },
    {
      from: 'on',
      ...
      transient: ['M12 3v7', 'M8 7a7 7 0 0 0 8 0'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'idle',
      to: 'recording',
      transientState: 'arming',
      transient: ['M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10Z'],
      motion: 'pulse',
    },
    {
      from: 'recording',
  ...
  transitions: [
    {
      from: 'unchecked',
      to: 'checked',
      transientState: 'checking',
      transient: ['M5 5h14v14H5z', 'm8 12 2 2 3-3'],
      motion: 'pulse',
    },
    {
      from: 'checked',
      to: 'unchecked',
      transientState: 'unchecking',
      transient: ['M5 5h14v14H5z'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      from: 'unselected',
      to: 'selected',
      transientState: 'selecting',
      transient: ['M12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Z', 'M12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z'],
      motion: 'pulse',
    },
    {
      from: 'selected',
      to: 'unselected',
      transientState: 'clearing',
      transient: ['M12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Z'],
      motion: 'replace',
    },
  ],
});
  ...
  transitions: [
    {
      ...
      to: 'active',
      transientState: 'starting',
      transient: ['M3 12h4l2-5 3 8 3-8 2 5h4'],
      motion: 'pulse',
    },
    {
      from: 'active',
      to: 'idle',
      transientState: 'settling',
      transient: ['M3 12h4l2-5 3 8 3-8 2 5h4'],
      motion: 'replace',
    },
  ],
  ...
  transitions: [
    {
      from: 'idle',
      to: 'locating',
      transientState: 'acquiring',
      transient: ['M12 21s6-5.5 6-11a6 6 0 1 0-12 0c0 5.5 6 11 6 11Z', 'M12 9h.01'],
      motion: 'pulse',
    },
    {
      from: 'locating',
      to: 'idle',
      transientState: 'releasing',
      transient: ['M12 21s6-5.5 6-11a6 6 0 1 0-12 0c0 5.5 6 11 6 11Z'],
      motion: 'replace',
    },
  ],
});
