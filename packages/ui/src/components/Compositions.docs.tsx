...
export const uiDocs = defineUiDocsGroup([
  {
    ...
    status: 'stable', accessibility: 'Associates title and description with the grouped card when supplied and preserves child semantics.',
  ...
  },
  {
    ...
    status: 'stable', accessibility: 'Uses a native button with aria-expanded/aria-controls and a labelled content region so controlled state never races native details mutation.',
  ...
  },
  {
    ...
    status: 'stable', accessibility: 'Each section uses a React-owned disclosure button/region pair; disabled buttons suppress activation and single-open mode normalizes invalid multi-value input.',
  ...
  },
  {
    ...
    status: 'stable', accessibility: 'Uses main/aside/footer landmarks while leaving caller-provided header semantics intact.',
  ...
  },
  {
    ...
    status: 'stable', accessibility: 'A labelled group keeps one Tab entry when spatial keyboard navigation is enabled; arrow keys choose the nearest tile in the requested 2D direction while each tile keeps native control semantics.',
  ...
  },
  {
    ...
    status: 'stable', accessibility: 'Actionable tiles use shared Button semantics; selection is visual by default or can opt into aria-current without pretending every selected tile is a toggle button.',
  ...
  },
  {
    ...
    status: 'stable', accessibility: 'The visible application name is the action name; image icons remain decorative unless the caller provides separate meaning.',
  ...
  },
  {
    ...
    status: 'stable', accessibility: 'Error state uses alert semantics, loading uses status semantics, and empty state stays neutral unless caller overrides role.',
