...
export function ToastQueueExample() {
  ...
  return (
    <Stack gap="sm">
      <Button onClick={() => queue.push({ message: 'Background sync completed', tone: 'success' })}>Push toast</Button>
...
export function BannerExample() {
  ...
  return visible ? (
    <Banner message="A newer version is available." action={{ label: 'Review', onAction: () => {} }} onDismiss={() => setVisible(false)} />
  ) : (
