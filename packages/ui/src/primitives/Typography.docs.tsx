...
export function TextMixedCopyExample() {
  return (
    <Stack gap="sm">
      ...
      <Text as="span" variant="caption" tone="tertiary">Inline caption remains a real span.</Text>
    </Stack>
  );
}
...
export function HeadingSemanticExample() {
  return (
    <Stack gap="xs">
      ...
      <Text tone="secondary">Rank belongs to document structure; visual scale does not rewrite it.</Text>
    </Stack>
  );
}
...
export function LabelMetadataExample() {
  return (
    <Stack gap="xs">
      <Label data-visual-cert="label" emphasis="strong" tone="accent">Certified metadata</Label>
